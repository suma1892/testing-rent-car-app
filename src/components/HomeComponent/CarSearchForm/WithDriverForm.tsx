...
import RentalDurationInput from './partials/RentalDurationInput';
...
const WithDriverForm: FC<{reset?: boolean}> = ({reset = true}) => {
  ...
  const {form, setForm, formError, setFormError, handleSearch} =
    useDailyCarSearchForm({withDriver: true, reset});
