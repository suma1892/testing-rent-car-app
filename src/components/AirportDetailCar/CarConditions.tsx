...
import {ConditionDetailProps} from 'components/DetailCarComponent/detailCarComponent.interface';
...
const CarConditions = () => {
  ...
  const operational = airportVehicleById?.garage_data?.operational?.find(
  ...
  return (
    <View style={styles.container}>
      ...
      <ConditionDetail
        ...
        show={!airportVehicleById.smoke_allowed}
      />
      <ConditionDetail
        icon={ic_disable}
        title={t('carDetail.disability')}
        show={airportVehicleById.disablility_allowed}
      />
      <ConditionDetail
        icon={ic_dog}
        title={t('carDetail.pet')}
        show={airportVehicleById.pet_allowed}
      />
      ...
      <ConditionDetail
        ...
        title={`${t('carDetail.operational_hours')} ${
          ...
          timezone: airportVehicleById?.garage_data?.location_time_zone as any,
        })})`}
