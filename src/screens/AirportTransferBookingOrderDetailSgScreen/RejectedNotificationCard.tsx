...
import {ic_notif_red, ic_order_notification} from 'assets/icons';
...
const RejectedNotificationCard = () => {
...
const styles = StyleSheet.create({
  container: {backgroundColor: theme.colors.low_red, padding: 20, borderRadius: 6, marginTop: 10},
